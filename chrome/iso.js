...
Iso = (function() {
  ...
  // ]
  COLORS = [new obelisk.CubeColor().getByHorizontalColor(0xeeeeee), new obelisk.CubeColor().getByHorizontalColor(0xe8f6a4), new obelisk.CubeColor().getByHorizontalColor(0xbbcd67), new obelisk.CubeColor().getByHorizontalColor(0x697b15), new obelisk.CubeColor().getByHorizontalColor(0x445200)];
