...
Iso = (function() {
  ...
  COLORS = [new obelisk.CubeColor().getByHorizontalColor(0xeeeeee), new obelisk.CubeColor().getByHorizontalColor(0xffee4a), new obelisk.CubeColor().getByHorizontalColor(0xffc501), new obelisk.CubeColor().getByHorizontalColor(0xfe9600), new obelisk.CubeColor().getByHorizontalColor(0x8a0000)];
